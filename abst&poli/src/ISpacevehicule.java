/**
 * Representa la interface que complementa los comportamientos de unos tipos de
 * nave
 * 
...
public interface ISpacevehicule {
    /**
     * Representa el metodo para identificar si tiene o no la capacidad de llevar
     * tripulación
     * 
